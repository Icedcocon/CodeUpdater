...
import (
	...
	webhookservingkserveiov1beta1 "github.com/Icedcocon/CodeUpdater/internal/webhook/v1beta1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "194ad80a.icedcocon.github.io",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = webhookservingkserveiov1beta1.SetupInferenceServiceWebhookWithManager(mgr); err != nil {
