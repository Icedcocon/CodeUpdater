...
import (
	...
	servingkserveiov1beta1 "github.com/Icedcocon/CodeUpdater/api/v1beta1"
	// TODO (user): Add any additional imports if needed
)

var _ = Describe("InferenceService Webhook", func() {
	var (
		obj       *servingkserveiov1beta1.InferenceService
		oldObj    *servingkserveiov1beta1.InferenceService
		validator InferenceServiceCustomValidator
		defaulter InferenceServiceCustomDefaulter
	)
